          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <div>
              ...
              <div className="space-y-3">
                <button
                  onClick={handleDirectBooking}
                  className="w-full bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center group"
                >
                ...
                <a
                  ...
                  className="w-full border border-neutral-600 hover:border-neutral-400 text-neutral-400 hover:text-white py-2 px-4 rounded-lg transition-all duration-300 flex items-center justify-center group"
                >
              ...
              <div className="mt-6 pt-6 border-t border-neutral-700">
                ...
                <div className="flex space-x-3">
                  <div className="w-8 h-8 bg-neutral-700 hover:bg-blue-600 rounded-full flex items-center justify-center cursor-pointer transition-colors">
                    <span className="text-xs font-bold">Li</span>
                  </div>
                  <div className="w-8 h-8 bg-neutral-700 hover:bg-blue-400 rounded-full flex items-center justify-center cursor-pointer transition-colors">
                    <span className="text-xs font-bold">Tw</span>
                  </div>
                  <div className="w-8 h-8 bg-neutral-700 hover:bg-blue-800 rounded-full flex items-center justify-center cursor-pointer transition-colors">
