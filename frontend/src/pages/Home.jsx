...
export default function Home() {
  ...
  const testimonials = [
    {
      ...
      content: "Asasy transformed how we assess technologies. The AI report identified market opportunities we completely missed. This platform is a game-changer for university TTOs.",
      rating: 5,
    },
    {
      id: 2,
      ...
      content: "The RTTP expert guidance helped us license our AI algorithm to a Fortune 500 company. The commercialization blueprint was incredibly detailed and actionable.",
      rating: 5,
    },
    {
      id: 3,
      ...
      role: "IP Manager",
      content: "We've reduced our technology assessment time from weeks to hours. The professional reports have impressed our stakeholders and increased our licensing success rate.",
      rating: 4,
    },
    {
      id: 4,
      ...
      content: "As a researcher, I had no idea how to commercialize my work. Asasy guided me through the entire process - from patent filing to licensing agreements. Truly invaluable!",
      rating: 5,
    },
  ];
 ...
 <section className="relative min-h-screen bg-gradient-to-br from-slate-50 via-white to-blue-50 pt-20 pb-32 overflow-hidden">
  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-to-r from-cyan-400/10 to-blue-400/10 rounded-full blur-3xl animate-pulse" style={{animationDelay: '1s'}}></div>
  </div>
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-medium text-slate-700">Trusted by 10,000+ innovators</span>
      </motion.div>
      ...
      >
        Transform your innovation into commercial success. Get comprehensive technology assessment reports with expert RTTP guidance. 
        <span className="font-semibold text-slate-800"> Start with a free report - no credit card required.</span>
      </motion.p>
...
<section className="py-2">
  ...
  <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
    <h2 className="text-3xl font-bold text-neutral-900 mb-10">Download Sample Reports</h2>
    <div className="grid grid-cols-1 sm:grid-cols-3 gap-8">
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-neutral-800 mb-2 group-hover:text-primary-600">Basic</h3>
        <p className="text-sm text-neutral-500">Ideal for early-stage IP assessments</p>
      </a>
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-neutral-800 mb-2 group-hover:text-secondary-600">Advance</h3>
        <p className="text-sm text-neutral-500">Includes licensing and market insights</p>
      </a>
      ...
      >
        ...
        <h3 className="text-xl font-semibold text-neutral-800 mb-2 group-hover:text-accent-600">Comprehensive</h3>
        <p className="text-sm text-neutral-500">Complete due diligence + commercialization plan</p>
      </a>
    </div>
  </div>
</section>
  ...
  <div className="absolute inset-0 z-0">
    ...
    <div className="absolute bottom-20 right-10 w-96 h-96 bg-gradient-to-r from-purple-400/8 to-pink-400/8 rounded-full blur-3xl animate-pulse" style={{animationDelay: '2s'}}></div>
  </div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    >
      ...
      >
        ...
        <span className="text-sm font-medium text-slate-700">Advanced IP Technology</span>
      </motion.div>
      ...
      >
        Everything you need to conduct thorough technology assessments and make 
        <span className="font-semibold text-slate-800"> data-driven commercialization decisions</span> with confidence.
      </motion.p>
    </motion.div>
  ...
  <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
    ...
    >
      <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/70 backdrop-blur-sm border border-slate-200 rounded-full mb-4 shadow-sm">
        ...
        <span className="text-sm font-medium text-slate-700">Live Innovation Network</span>
      </div>
      <h3 className="text-xl font-semibold text-slate-600 mb-2">
        Trusted by innovators at
      </h3>
      <p className="text-sm text-slate-500 max-w-2xl mx-auto">
        Join thousands of technology leaders who trust our AI-powered assessment platform
      </p>
    </motion.div>
    ...
    <div className="relative">
      ...
      <div className="relative overflow-hidden rounded-3xl bg-white/60 backdrop-blur-xl border border-white/20 shadow-2xl p-8 md:p-12">
        ...
        <div className="absolute inset-y-0 left-0 flex items-center">
          <button
            ...
            onClick={() => setActiveLogoIndex(prev => (prev === 0 ? logos.length - 1 : prev - 1))}
          >
        ...
        <div className="absolute inset-y-0 right-0 flex items-center">
          <button
            ...
            onClick={() => setActiveLogoIndex(prev => (prev + 1) % logos.length)}
          >
      ...
      <div className="flex justify-center mt-4">
        <div className="inline-flex items-center gap-2 px-3 py-1 bg-white/70 backdrop-blur-sm border border-slate-200 rounded-full text-xs text-slate-600">
  ...
  <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    >
      ...
      <p className="text-xl text-slate-600 max-w-3xl mx-auto leading-relaxed">
        ...
        <span className="text-blue-600 font-semibold"> systematic 6-step methodology</span>
      </p>
    </motion.div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-neutral-600 max-w-2xl mx-auto">
              Join thousands of researchers and innovators accelerating IP commercialization.
            </p>
          </motion.div>
