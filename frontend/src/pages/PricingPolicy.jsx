        ...
        <div className="prose prose-lg max-w-none">
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              By accessing or using the Assesme platform (www.assesme.com), you
              agree to be legally bound by these Terms and Conditions, including
              our Privacy Policy and Refund & Cancellation Policy. These terms
              govern all users, including individuals, institutions,
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Assesme does not claim ownership of any inventions or ideas
              disclosed in the reports. Users are responsible for securing IP
              protection or maintaining confidentiality as needed.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-gray-700 mb-4">
              Users are advised not to upload unpublished or highly confidential
              intellectual property without proper safeguards.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 text-gray-700 space-y-2 mb-4">
              ...
              <li>Decisions based on AI-generated content</li>
              <li>
                Legal or financial impact of third-party service processing
              </li>
            </ul>
            <p className="text-gray-700 mb-4">
